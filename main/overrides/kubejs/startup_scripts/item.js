...
onEvent('item.registry', event => {
	...
	event.create('engulfing_lightning').displayName('薙草之稻光').type('sword').tier('engulfing_lightning').glow(true);
	event.create('nwither_plush').displayName('NWitherKawaii 毛绒玩偶')
})
